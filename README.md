...
Click on the run to view the execution details. Verify that all steps completed successfully, particularly the "**HTTP - Send SAST Batch to DCR**" step inside the `For_Each_-_Scan` loop.
